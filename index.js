...
app.use(
  express.static(
    __dirname + "/node_modules/socket.io/node_modules/socket.io-client/dist"
  )
);
...
app.use(function(request, response, next) {
  ...
  getDateFull = parseInt(
    getDateFull.getMonth() +
      "" +
      getDateFull.getDate() +
      "" +
      getDateFull.getHours() +
      "" +
      getDateFull.getMinutes() +
      "" +
      getDateFull.getSeconds() +
      "" +
      getDateFull.getMilliseconds()
  );
...
mongoose.connect(
  "mongodb://heroku_jzh3ndmz:gt0kqpf30michom691ku6fkj68@ds123361.mlab.com:23361/heroku_jzh3ndmz"
);

// 회원관련
global.MEMBERLIB = require("./public/lib/member/member.js").member(
  app,
  mongoose
);
...
// 기타페이지들
require("./public/lib/others/pages.js").food_search(app);
