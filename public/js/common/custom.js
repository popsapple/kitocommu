...
function DisableGnbDropdown(obj,callback,callback02,type){ // PC판 이상일때 드롭다운 중지
...
$(document).ready(function() {
  ...
  if($('.main_kito_faq')){
    ...
    DisableGnbDropdown(".main_kito_faq > ul > li","","","faq");
  }
  if($('.main_visual')){
